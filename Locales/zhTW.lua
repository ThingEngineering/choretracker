...
L['chore:midnight:patch_12_0_0:quests:neighborhood'] = '社區'
...
L['chore:leveling:midnight:quests:delves'] = 'Delves'
...
-- Auto-Accept
L['autoAccept:acceptQuest'] = '接受任務'
L['autoAccept:startQuest'] = '開始任務'
L['autoAccept:choresEvents:holidays:delves'] = '^獎勵事件：探究$'
L['autoAccept:choresEvents:holidays:mythicDungeons'] = '^獎勵事件：地城$'
L['autoAccept:choresEvents:holidays:pvpPetBattles'] = '^獎勵事件：寵物對戰$'
L['autoAccept:choresEvents:holidays:timewalkingDungeons'] = '^獎勵事件：時光漫遊$'
