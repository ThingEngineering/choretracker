...
L['option:display:awakenedTimers'] = 'Afficher uniquement les minuteries activées'
...
L['chore:prey:midnightPrey:drops:nightmare'] = 'Cauchemard'
...
L['autoAccept:choresEvents:holidays:worldQuests'] = '^ÉvènemÉvènement bonus Expéditions$'
